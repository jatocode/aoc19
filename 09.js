...
console.log('Del 1:', intcode(inputprogram, () => { return 1}, () => {}));
console.log('Del 2:', intcode(inputprogram, () => { return 2}, () => {}));

function intcode(program, input = () => { return 0}, output = (x) => { console.log(`Output: ${x}`) } ) {
    let a, b, o, pc = 0;
    let rb = 0;
    let running = true;
